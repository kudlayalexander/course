...
from view.lesson_window import LessonsWindowT
...
from controller.lesson_controller import LessonsController
...
class MainWindow(QWidget):
    def __init__(self):
        ...
        self.tabs.addTab(EducationalProgramsWindow(self.faculties_controller, self.educational_programs_controller), "Образовательные программы")
        ...
        self.tabs.addTab(LessonsWindowT(self.weeks_controller, self.lessons_controller), "Время занятий")
        self.tabs.addTab(
