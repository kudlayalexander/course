...
class TeacherScheduleWindow(QWidget):
    ...
    def __init__(
        ...
        subjects_controller,
        weeks_controller,
        teacher_schedule_controller,
    ):
        super().__init__()
        self.setWindowTitle("Расписание преподавателей")
        ...
        self.teacher_schedule_controller = teacher_schedule_controller
    ...
    def update_table(self):
        schedule_entries = (
            self.teacher_schedule_controller.get_all_schedule_entries()
        )
    ...
    def delete_schedule_entry(self):
        ...
        if selected_rows:
            for row in selected_rows:
                ...
                self.teacher_schedule_controller.delete_schedule_entry(
                    schedule_id
                )
            self.update_table()
        else:
...
class AddScheduleEntryDialog(QDialog):
    ...
    def add_schedule_entry_to_db(self):
        ...
        self.teacher_schedule_controller.add_schedule_entry(
